...
public class Cadastrar extends GenericActivity {
	EditText editCPF, editNome, editDataNasci, editDisciplina;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editDisciplina = (EditText) findViewById(R.id.editText4);
		...
		btnCadastrar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String s4 = editDisciplina.getText().toString();
	...
	public String PostData(String[] valuse) {
		...
		try {
			...
			HttpPost httpPost = new HttpPost("http://" + Constantes.IP_SERVIDOR
					+ ":8080/HttpPostServlet1/servlet/cadastrarProfessor");
			...
			list.add(new BasicNameValuePair("disciplina", valuse[3]));
